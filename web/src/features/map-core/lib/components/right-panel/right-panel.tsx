...
import { MessageSquare, FileText, Palette, Tag } from 'lucide-react';
 ...
 * AI tab is always visible. Attributes/Style/Label tabs only appear when triggered.
...
export function RightPanel() {
  ...
  }, [editPanelOpen, stylePanelOpen, labelPanelOpen, setRightPanelActiveTab]);

  // Dynamic tabs: AI always visible, attributes/style/label only when triggered
