...
import { RENDERING_TYPE_OPTIONS, CLASSIFICATION_METHOD_OPTIONS } from './color-ramps';

// Re-export for convenience
export { RENDERING_TYPE_OPTIONS, CLASSIFICATION_METHOD_OPTIONS } from './color-ramps';
...
export type ControlType =
  ...
  | 'lineType' // 线型下拉 (线)
  | 'outline' // 边框控制组 (面)
  | 'renderingType' // 渲染类型选择器（新增）
  | 'graduatedColors'; // 分级色彩面板（新增）
