...
import { GeometryType, IngestStatus, DatasetScope } from '@prisma/client';

export enum DatasetComplexityLevel {
  XS = 'XS',
  S = 'S',
  M = 'M',
  L = 'L',
...
export class DatasetResponseDto {
  ...
  @IsEnum(DatasetScope)
  scope!: DatasetScope; // Always present due to DB default
